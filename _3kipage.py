...
api_key = st.secrets["open_apikey"]
assitant_id = st.secrets["assitant_id"]
def show_ki_page():
 ...
 # Set openAi client , assistant ai and assistant ai thread
    ...
    def load_openai_client_and_assistant():
        ...
        my_assistant    = client.beta.assistants.retrieve(assitant_id)
    ...
    st.title("FitEKG Helfer in der Net")
